...
const IconGithub = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <rect width="30" height="30" fill="url(#pattern0_2_9)" />
      <defs>
        <pattern
          id="pattern0_2_9"
